...
export async function forgeRockConfig() {
  try {
    ...
    const env = {
      dev: 'https://publish-p139617-e1446293.adobeaemcloud.com',
      stage: 'https://publish-p139617-e1446249.adobeaemcloud.com',
      prod: 'https://publish-p139617-e1446342.adobeaemcloud.com',
    };
